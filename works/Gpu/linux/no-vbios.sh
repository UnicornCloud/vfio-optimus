...
qemu-system-x86_64 \
  ...
  -device vfio-pci,host=01:00.0,bus=root.1,addr=00.0,x-pci-sub-device-id=0x11e9,x-pci-sub-vendor-id=0x1462,multifunction=on \
...
\
  ...
  -device usb-tablet \
  -net bridge,br=virbr0 -net nic,model=e1000e
